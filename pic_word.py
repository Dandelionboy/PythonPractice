...
graph = imread(r"D:\Python_project\PythonPractice\mask.jpg")
# 获取图片的颜色作为文字颜色
image_colors = ImageColorGenerator(graph)
# 生成词云图，这里需要注意的是WordCloud默认不支持中文，所以这里需已下载好的中文字库
wc = WordCloud(font_path=r"D:\Python_project\PythonPractice\msyh.ttf", width=600, height=600, margin=10,
               max_font_size=64
